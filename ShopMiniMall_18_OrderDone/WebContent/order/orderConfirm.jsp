...
<% 
 CartDTO cDTO = (CartDTO) request.getAttribute("cDTO");
	...
	int num = cDTO.getNum(); //cart에서 삭제할 때 써야함
...
<!-- hidden 처리-->
<!--  num값 넘겨줘야함-->
<form name="myForm" method="get" action="CartOrderDoneServlet"> <!-- 실제 주문을 하게 됨 , 아래에서 상품에 대한 정보를 숨겨서 넘김-->
				...
				<tr>
					...
					<td height="35" class="td_default">
						<input class="input_default" type="text" id="phone"
							name="phone" size="15" maxlength="15" value="<%=phone1%>-<%=phone2%>-<%=phone3%>"></input>
